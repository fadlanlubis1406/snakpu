...
<section class="placed-orders">
   ...
   <center>
      <a target="_blank" href="generate_pdf.php" class="btn">Cetak PDF</a>
   </center>
   <br><br>
   ...
   <div class="box-container" id="order-container">
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" class="delete-btn" onClick="return confirm('delete this order?');">Hapus</a>
         </form>
      </div>
      <?php
         }
...
<script>
   function printPDF() {
      ...
      let content = document.getElementById('order-container').innerHTML;
