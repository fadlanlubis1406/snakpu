    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="Address Baris 1">
            </div>
            <div class="inputBox">
                <span>address line 02 :</span>
                <input type="text" name="street" placeholder="Address Baris 2">
            </div>
            <div class="inputBox">
                <span>city :</span>
            ...
            <div class="inputBox">
                <span>state :</span>
                <input type="text" name="state" placeholder="Sumatera Utara">
            </div>
            <div class="inputBox">
                <span>country :</span>
