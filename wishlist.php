...
<section class="wishlist">
    ...
    $grand_total += $fetch_wishlist['price'];
        ...
        echo '<p class="empty">favorit kamu kosong!</p>';
    }
    ?>
    </div>

    <div class="wishlist-total">
        <p>total harga: <span>$<?php echo $grand_total; ?>/-</span></p>
        <a href="shop.php" class="option-btn">Lanjut belanja</a>
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onClick="return confirm('delete all from wishlist?');">Hapus semua</a>
    </div>
