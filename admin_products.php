...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" class="box" required placeholder="masukan nama produk" name="name">
      <input type="varchar" min="0" class="box" required placeholder="masukan harga produk" name="price">
      <textarea name="details" class="box" required placeholder="masukan detail produk" cols="30" rows="10"></textarea>
