...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" class="box" placeholder="masukan username" required>
      ...
      <input type="password" name="cpass" class="box" placeholder="kofirmasi password" required>
